...
const T = {
  ...
  audit_log_desc:         { ar: "سجل كامل لجميع العمليات والإجراءات", en: "Complete log of all operations and actions" },
  export_audit_log:       { ar: "تصدير سجل التدقيق",              en: "Export Audit Log" },
  audit_time:             { ar: "الوقت",                           en: "Time" },
  audit_user:             { ar: "المستخدم",                        en: "User" },
  audit_action:           { ar: "الإجراء",                         en: "Action" },
  audit_entity:           { ar: "الكيان",                          en: "Entity" },
  audit_ip:               { ar: "عنوان IP",                        en: "IP Address" },
  audit_status:           { ar: "الحالة",                          en: "Status" },
  audit_filter_from:      { ar: "من تاريخ",                        en: "From Date" },
  audit_filter_to:        { ar: "إلى تاريخ",                       en: "To Date" },
  audit_filter_action:    { ar: "نوع الإجراء",                     en: "Action Type" },
  audit_all_actions:      { ar: "جميع الإجراءات",                  en: "All Actions" },
  no_audit_logs:          { ar: "لا توجد سجلات مطابقة للفلتر",    en: "No audit logs match the current filter" },
  showing_entries:        { ar: "عرض {from}–{to} من أصل {total}", en: "Showing {from}–{to} of {total} entries" },
  audit_summary:          { ar: "ملخص",                            en: "Summary" },
  total_records:          { ar: "إجمالي السجلات",                  en: "Total Records" },
  report_period:          { ar: "فترة التقرير",                    en: "Report Period" },
  export_date:            { ar: "تاريخ التصدير",                   en: "Export Date" },
  most_common_action:     { ar: "أكثر الإجراءات تكراراً",          en: "Most Common Action" },
  freeze_count:           { ar: "عدد حالات التجميد",               en: "Freeze Count" },
  analysis_count:         { ar: "عدد التحليلات",                   en: "Analysis Count" },
  prev_page:              { ar: "السابق",                          en: "Previous" },
  next_page:              { ar: "التالي",                          en: "Next" },
